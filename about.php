        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p class="pb-3" data-aos="zoom-in-up">
					...
					unterstützt.<br>
					<span class="about-section__quote">Marion Wolf-Dietrich (Vorstand) </span>:<br>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p data-aos="zoom-in-up">
					<span class="about-section__quote">Patricia Renz (Vorstandsvorsitz)</span>:<br>
					...
					Band Projekten.<br>
					<span class="about-section__quote">Bethina Walbaum (Vorstand)</span>:<br>
