		...
		<div class="row">
			<div class="col-sm-12">
				...
				<p data-aos="zoom-in-up">
					„Wir von Musica Altona möchten Kindern ein Fenster zur Musik öffnen, die sonst keinen Zugang dazu hätten. Dabei ist es uns wichtig, mit Spaß und Freude am Musizieren Kinder und Jugendliche in ihrem Selbstvertrauen zu stärken. Jeder Auftritt und der Applaus, aber auch schon die kleinen Erfolge im Unterricht, bringen die Kinder voran – z.B. wenn es plötzlich nach einigem Üben 'klingt' und manchmal sogar richtig einen 'Flow' schafft. Wir sind überzeugt, dass die Kraft der Musik und des gemeinsamen Musizierens etwas Besonderes ist.“<br>
					<span class="about-section__quote">Patricia Renz (Vorstandsvorsitz)</span>
				</p>
				<p>
					Unter der Leitung von erfahrenen Dozenten*innen und Musikpädagogen*innen treffen sich die Schülerinnen und Schüler in Altonaer Schulen und anderen Einrichtungen, wie zum Beispiel dem Jugendkunsthaus ESCHE. Auf einen einzigen Musikstil müssen sich die inzwischen über 300 Nachwuchsmusiker*innen nicht festlegen, denn bei Musica Altona wird in verschiedenen Gruppen »Crossover« musiziert: von Schlagzeug, Blasinstrumenten, Klavier, Keyboard, Trommeln, Saz, Ukulele und Gitarre bis zur klassischen Geige & Bratsche, Cello, Musiktheorie-und Gehörbildung sowie Band Projekten.
				</p>
				<p>
					„Ob Elternstunde oder unser KinderMusikfest - für manche Kinder ist es der erste Auftritt, andere sind schon länger dabei. Bei allem steht aber immer der Spaß an erster Stelle. Es geht nicht um eine perfekte Darbietung, sondern um den Mut aufzutreten und etwas von dem Erlernten zeigen zu wollen.“<br>
					<span class="about-section__quote">Bethina Walbaum (Vorstand)</span>
				</p>
				<p>
					Mit dem 'Rollenden Musikkoffer', der regelmäßig durch die Kitas des Stadtteils zieht, erleben schon die ganz Kleinen seit vielen Jahren ein lebendiges Programm der musikalischen Früherziehung. Anfang 2019 kam 'Bellas Klangtonne' dazu, ein Projekt für die Elementar Kinder in Kitas, im März 2022 folgte 'Bella spielt Ukulele'.
					Bereits hier wird das Prinzip des Gruppenunterrichts gepflegt, der sich dann für Kinder ab dem ersten Schuljahr in den Instrumental- und natürlich auch Orchestergruppen fortsetzt.
				</p>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				...
				<p class="pb-3" data-aos="zoom-in-up">
					Seit 2002 ist der große und von Herzen kommende Einsatz aller Beteiligten bezeichnend für Musica Altona. Die Kursgebühren sind moderat und die Organisation schlank. So wird es jungen Menschen ermöglicht - auch denjenigen, die neu in der Stadt sind - einen leichteren Zugang zu ihrem Stadtteil und anderen Jugendlichen zu finden.
				</p>
			</div>
		</div>
