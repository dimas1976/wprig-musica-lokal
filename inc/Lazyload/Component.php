...
/**
 * Class for managing lazy-loading img.
 */
class Component implements Component_Interface {
	...
	/**
	 * Initializes lazy-loading img functionality.
	 */
	...
	public function action_customize_register_lazyload( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'lazy_load_media',
			[
				'label'           => __( 'Lazy-load img', 'wp-rig' ),
				'section'         => 'theme_options',
				'type'            => 'radio',
				'description'     => __( 'Lazy-loading img means img are loaded only when they are in view. Improves performance, but can result in content jumping around on slower connections.', 'wp-rig' ),
	...
	/**
	 * Adds filters to enable lazy-loading of img.
	 */
	...
	public function action_enqueue_lazyload_assets() {
		...
		wp_script_add_data( 'wp-rig-lazy-load-img', 'precache', true );
	}

	/**
	 * Removes filters for img that should not be lazy-loaded.
	 */
	...
	public function filter_allow_lazyload_attributes( array $allowed_tags ) : array {
		...
		// But, if img are allowed, ensure that our attributes are allowed!
