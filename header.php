...
<head>
    ...
    <style>
			*{margin:0;padding:0}body{background-color:#fff}p{font-size:1rem}.navbar-nav .nav-item a.nav-link{font-family:Lato,sans-serif;font-size:.938em;font-weight:700;color:#0099ed}.navbar-light .navbar-nav .active>.nav-link{color:#8ad2fb !important;}#logo .slogan{font-family:'Love Ya Like A Sister',sans-serif;font-weight:600;color:#000}#logo .slogan p{font-size:2.2rem}nav li.active{border-bottom:1px solid #c90f0d}nav .navbar-toggler{border:0}#motiv .container{max-width:100%;background-color:rgba(220,160,140,0)}#motiv .container .col{margin:auto}#motiv .container .col p{font-family:LORA-REGULAR;color:#fff}#motiv .container .col p q{quotes:' \201C ' ' \201D '}@media (max-width:575px){#logo .musica-logo{text-align:center}#logo .slogan p{text-align:center;font-size:1.4rem}#logo .herz{text-align:center}nav.navbar{padding-bottom:0;padding-left:0;padding-right:0}nav .container{min-width:100%}nav .container .row{width:100%}nav .container .row .navbar-collapse{margin-left:-24px;margin-right:-53px}nav .container .row .navbar-collapse ul{background-color:#ebeff2;padding-left:2rem}nav .container .row .navbar-collapse li{padding-left:.5rem;border-bottom:1px solid #e0e0e8}nav .container .row .navbar-collapse li .nav-link{color:#777}#motiv{height:14.75rem;background:url(<?= bloginfo("template_url"); ?>/img/motiv/gino_banner_xs.jpg) top center no-repeat;background-size:cover}}@media (min-width:576px) and (max-width:767px){#logo .slogan p{font-size:1.6rem}nav.navbar{padding-bottom:0;padding-left:0;padding-right:0}nav .container{min-width:100%}nav .container .row{width:100%}nav .container .row .navbar-collapse{margin-left:-24px;margin-right:-53px}nav .container .row .navbar-collapse ul{background-color:#ebeff2;padding-left:2rem}nav .container .row .navbar-collapse li{padding-left:.5rem;border-bottom:1px solid #e0e0e8}nav .container .row .navbar-collapse li .nav-link{color:#777}#motiv{height:15.4rem;background:url(<?= get_bloginfo("template_url"); ?>/img/motiv/gino_banner_sm.jpg) top center no-repeat;background-size:cover}}@media (min-width:768px) and (max-width:799px){#motiv{height:23rem;background:url(<?= get_bloginfo("template_url"); ?>/img/motiv/gino_banner_md.jpg) top center no-repeat;background-size:cover}#motiv .container .col p{text-shadow:2px 0px #000}}@media (min-width:800px) and (max-width:992px){#logo .slogan p{font-size:1.6rem}#motiv{height:23rem;background:url(<?= get_bloginfo("template_url"); ?>/img/motiv/gino_banner_md.jpg) top center no-repeat;background-size:cover}}@media (min-width:992px) and (max-width:1299px){#logo .slogan p{font-size:1.6rem}#motiv{height:19rem;background:url(<?= get_bloginfo("template_url"); ?>/img/motiv/gino_banner_lg.jpg) center center no-repeat;background-size:cover}#motiv .container .col p{text-shadow:2px 0px #000}}@media (min-width:1200px){#logo .slogan p{font-size:1.7rem}#motiv{height:26rem;background:url(<?= get_bloginfo("template_url"); ?>/img/motiv/gino_banner_lg.jpg) center center no-repeat;background-size:cover}#motiv .container .col p{text-shadow:2px 0px #000}}@media (min-width:1300px){#motiv{height:44rem;background:url(<?= get_bloginfo("template_url"); ?>/img/motiv/gino_banner_xlg.jpg) center center no-repeat;background-size:cover}#motiv .container .col p{text-shadow:2px 0px #000}}
    </style>
